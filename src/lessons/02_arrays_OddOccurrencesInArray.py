...
def solution(A):
    missing_number = 0
    for i in A:
        missing_number ^= i  # performing XOR
...
# XOR Explanation
# XOR of same number is 0. It can be written as +2 -2 => 0
# Even if we throw some random numbers in between, same number repeating twice will result cancel out each other.
print(0 ^ 2)  # Result is 2
print(2 ^ 2)  # Result is 0
print(2 ^ 3 ^ 2)  # Result is 3
